...
```{r getdat}
today <- '20191028' # edit for fresh snapshot
...
Decodes for short code lists are all in one large table called SALI_REF_CODES, grouped by field RV_DOMAIN. See '/helpers/REF_CODE_DOMAINS_for_sites.xlsx' for some metadata.
...
sph_bab <- dplyr::filter(sit_data[['FTS']], PROJECT_CODE == 'BAB' &
