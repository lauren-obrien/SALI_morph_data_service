...
```{r getdat}
today <- '20191025' # edit for fresh snapshot
...
Note2: Might be worth dropping the created/updated fields to save space??? 'bout 450MB atm

***

Get decodes into another list
...
if(file.exists(decode_datafile)) {
  ...
  decodes <- 
    list(
      ...
      # the others are large enough to have their own tables
