...
```{r getdat}
today <- '20190928' # edit for fresh snapshot
      ...
      "SIT" = 
        dbGetQuery(SALI,
            "with temp1 as (
             ...
             select * from temp1
             left join sit_sites using (project_code)
      ...
      "LOC" = # grabbing all but SHAPE col, ROracle can't handle SDO_GEOM :(
        dbGetQuery(SALI,
            "with temp1 as (
             ...
             from temp1
             left join sit_locations using (project_code)
             where datum = 3
             and longitude > 1
             order by project_code, site_id, obs_no"),
      "CLA" = 
        dbGetQuery(SALI,
            "with temp1 as (
             ...
             select * from temp1
             left join sit_soil_classifications using (project_code)
      ...
      "DIS" = 
        dbGetQuery(SALI,
            "with temp1 as (
             ...
             select * from temp1
             left join sit_disturbances using (project_code)
      ...
      "MIC" = 
        dbGetQuery(SALI,
            "with temp1 as (
             ...
             select * from temp1
             left join sit_microreliefs using (project_code)
      ...
      "SCF" =
        dbGetQuery(SALI,
            "with temp1 as (
             ...
             select * from temp1
             left join sit_surf_coarse_frags using (project_code)
      ...
      "OTC" = 
        dbGetQuery(SALI,
            "with temp1 as (
             ...
             select * from temp1
             left join sit_rock_outcrops using (project_code)
      ...
      "HOR" = 
        dbGetQuery(SALI,
            "with temp1 as (
             ...
             select * from temp1
             left join sit_horizons using (project_code)
             order by project_code, site_id, obs_no, horizon_no")
      # add horizon-level stuff later
    )
